...
class MedianCoffeeSpentReport(ReportBase):
    ...
    def CreateReport(self):
        ...
        sorted_data = sorted(report_data, key=lambda x: x['median-coffee-spent'], reverse=True)
        return [[item['student'], round(item['median-coffee-spent'], 2)] for item in sorted_data]
